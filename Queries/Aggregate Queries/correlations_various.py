...
def main(inputs):
    ...
    helpful_df = helpful_df.withColumn('length_words', word_count(reviews_df.review_body)).select('helpfulness_percentage','star_rating', 'length_words')
...
if __name__ == '__main__':
    ...
    spark = SparkSession.builder.appName('Various Correlations').getOrCreate()
