...
def main(inputs,start_year,end_year):
	...
	stopwords.update(["take","look","put","around","Row","review_body","br","quot","although","now","say","well","new","made","much","make","got","each","take","use","may","without","part","want","makes","even","many","used","yet","going","set","come","go","found","another","seem"])
	...
	relative_scaling=0
	mode="RGB"
	save_as_name="img/"+image_name

	wordcloud = WordCloud(relative_scaling=relative_scaling,min_font_size=min_font_size,mode=mode,font_path=font_path,mask=cloud_mask,width=width,height=height,stopwords=stopwords, max_words=max_words, background_color=background_color,contour_width=contour_width,contour_color=contour_color).generate(str(text_review))
	plt.figure()
