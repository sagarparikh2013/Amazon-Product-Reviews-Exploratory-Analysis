...
def main(inputs,start_year,end_year):
	...
	wordcloud = WordCloud(font_path="fonts/forbes_bold.ttf",width=1000,height=800,stopwords=stopwords, max_words=75, background_color="black").generate(str(text_review))
	plt.figure()
