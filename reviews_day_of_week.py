...
def main(inputs):
    ...
    reviews_count_vs_years_plot.savefig('reviews_count_vs_years_'+inputs+'.png')
    # data = [go.Histogram(x=reviews_count_vs_years.toPandas()['year'],y=reviews_count_vs_years.toPandas()['count'])]
    # sns.lmplot(data, filename='spark/ratings_count_vs_years')
